...
function help( pushname ) {
    return `
Assalamu’alaikum, *${pushname}*!
Terima kasih telah menghubungi
*${botname}*

Pusat informasi:
       
🔰 Ketik *@0* Untuk Brosur PMB
🔰 Ketik *@1* Untuk Biaya Pendidikan
🔰 Ketik *@2* Untuk Beasiswa
🔰 Ketik *@3* Untuk Social Media
🔰 Ketik *@4* Untuk Tanya Admin
🔰 Ketik *@5* Untuk Lokasi 
...
🔰 Ketik *@31* Untuk Website
🔰 Ketik *@32* Untuk Youtube
🔰 Ketik *@33* Untuk Instagram
🔰 Ketik *@34* Untuk Twitter
🔰 Ketik *@35* Untuk Facebook
    
 -----[ *POWERED BY MCPR* ]----- `
}
exports.sosmed = sosmed()

function lokasipmt() {
    return `
Politeknik Muhammadiyah Tegal
Jl. Melati No.27, Kejambon, Kec. Tegal Tim., Kota Tegal, Jawa Tengah 52124
(0283) 351081
https://maps.app.goo.gl/9HqaYLMMGb1Tqkz99`
}
exports.lokasipmt = lokasipmt()
